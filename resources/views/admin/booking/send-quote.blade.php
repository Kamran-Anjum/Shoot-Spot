    ...
    <div class="page-content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/send-quote/'.$booking_id) }}" > {{ csrf_field() }}
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input required="" type="number" id="quote" name="quote" class="form-control" placeholder="">
                                            <input type="hidden" id="user_id" name="user_id" value="{{ $booking->user_id }}" class="form-control" placeholder="">
                                            <input type="hidden" id="user_name" name="user_name" value="{{ $booking->userName }}" class="form-control" placeholder="">
