...
@include('layout.adminLayout.admin-header')
@include('layout.adminLayout.admin-sidebar')



@yield('content')

@include('layout.adminLayout.admin-footer')
</div>
...
<script type="text/javascript">
    ...
    <script src="{{ asset('js/backend-js/packageoptions.js') }}"></script>
